      ...
      >
        <View className="flex-1 items-center justify-center px-6 py-10">
          ...
          <View className="items-center mb-8">
            <Text
              className="text-cyber text-4xl font-bold"
            ...
            <View className="w-full bg-app-card rounded-2xl p-6 border border-cyber/20">
              ...
              <View className="mb-5">
                ...
                <View className="flex-row items-center bg-app-input rounded-xl px-4 py-3 border border-white/10">
                  <Ionicons name="person-outline" size={18} color={Colors.cyber} />
                  <TextInput
          ...
          >
            ...
            >
              ...
              <Text className="text-cyber font-bold">ENTRAR</Text>
            </Text>
          </TouchableOpacity>
...
// Corner decorators require asymmetric borderWidth — kept in StyleSheet
