...
import br.com.upfit.groupservice.dto.WorkoutRecordedEvent;
    ...
    public void poll() {
        ...
        for (Message message : response.messages()) {
            try {
                ...
                groupService.processWorkoutRecorded(event);
                deleteMessage(message.receiptHandle());
            } catch (Exception e) {
                log.error("[group-service] Erro ao processar mensagem: {}", e.getMessage(), e);
            }
        }
    }
